...
| 2026-09-07 | v0.4.1 | Rewrote docs/FLOWS.md setup and journey sections as a concrete walkthrough | First pass simplified the diagrams but left the wording aimed at contributors; a PM reading it still could not tell what happens when they ask a question, so both sections now follow one real example end to end |
